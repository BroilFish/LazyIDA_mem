    ...
    def activate(self, ctx):
        if self.action in ACTION_CONVERT:
            ...
            if idaapi.read_selection(view, t0, t1):
                ...
                size = idc.get_item_size(start)+1
                end = start + size
            else:
                return False
...
class LazyIDA_t(idaapi.plugin_t):
    ...
    def init(self):
        ...
        hotkey_actions = (
            ...
            idaapi.action_desc_t(ACTION_GOTOEA, "Goto EA", hotkey_action_handler_t(ACTION_GOTOEA), "Shift-Q", "Goto EA", 0),
        )
